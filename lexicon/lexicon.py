LEXICON: dict[str, str] = {
    ...
    '/start': 'Привет! Тебя приветствует <b>FACEIT STATS BOT</b>\n'
              ...
              '2️⃣ <b>/top</b> - посмотреть топ 10 игроков разных регионов\n'
              '3️⃣ <b>/info</b> - помощь по командам бота\n'
              '4️⃣ <b>/help</b> - написать разработчику',
    '/info': 'Этот бот создан для того, чтобы отслежить статистику пользователей на <b>FACEIT</b>\n'
             'В данный момент бот имеет лишь 2 функции, чтобы их посмотреть введите:\n\n'
             '<b>/stats &lt;nickname&gt;</b>\n'
